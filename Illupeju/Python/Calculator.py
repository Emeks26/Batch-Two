#Ekene-Ogbolu Bolanle
#bolaogundipe@gmail.com
#08027580019
from tkinter import*
...
txtDisplay = Entry(cal,font=('arial', 15, 'bold'), textvariable=text_input, bd=30, insertwidth=4,
...
Addition=Button(cal,padx=16,pady=16,bd=8, fg="black", font=('arial',15, 'bold'),
...
Multiplication=Button(cal,padx=16,pady=16,bd=8, fg="black", font=('arial', 15, 'bold'),
...
btnClear=Button(cal,padx=16,pady=16,bd=8, fg="black", font=('arial', 15, 'bold'),
            text="C", bg="powder blue", command=btnClearDisplay).grid(row=4,column=1)

btnEquals=Button(cal,padx=16,pady=16,bd=8, fg="black", font=('arial', 15, 'bold'),
